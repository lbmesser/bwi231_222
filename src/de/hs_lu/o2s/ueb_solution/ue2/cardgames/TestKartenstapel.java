...
public class TestKartenstapel extends TestCase {
	...
	/*
	 * public void testKonstruktorSpielInt() { Kartenstapel myStapel1 = new
	 * Kartenstapel(4); assertFalse(myStapel1.empty()); assertEquals(208,
	 * myStapel1.getKartenAnzahl()); }
	 */
	...
	public void testRandom() {
		...
		assertTrue(randomCard == myCard1 || randomCard == myCard2 || randomCard == myCard3 || randomCard == myCard4
				|| randomCard == myCard5 || randomCard == myCard6 || randomCard == myCard7 || randomCard == myCard8);
	...
	/*
	 * public void testMischen(){ Kartenstapel myStapel1 = new Kartenstapel(new
	 * Kartenspiel()); myStapel1.mischen(); //System.out.println(myStapel1); }
	 */
